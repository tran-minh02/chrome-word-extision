...
2. Vào mục **SQL Editor** -> Tạo New Query -> Copy toàn bộ nội dung file [database_design.md](./database_design.md) dán vào và nhấn **Run** (đặc biệt lưu ý các dòng `GRANT ALL ON TABLE public.vocabularies TO authenticated;`).
